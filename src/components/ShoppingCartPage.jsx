          ...
          <div className="space-y-6">
            {cartItems.map((item) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <h3 className="text-purple-100 text-xl font-semibold">
                      {item.name}
                    </h3>
                    <p className="text-purple-300">Quantity: {item.quantity}</p>
                    <p className="text-purple-300">
                      Shipping: {currencySymbols[currency]}
                      {(convertPrice(getShippingFee(item)) * item.quantity).toFixed(2)}
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-purple-900/30 backdrop-blur-sm rounded-xl p-6 mt-8">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl text-purple-100 font-bold">Products Total:</h2>
                <p className="text-2xl text-purple-100 font-bold">
                  {currencySymbols[currency]}{productTotal.toFixed(2)}
                </p>
              </div>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl text-purple-100 font-bold">Shipping Total:</h2>
                <p className="text-2xl text-purple-100 font-bold">
                  {currencySymbols[currency]}{shippingFeeTotal.toFixed(2)}
                </p>
              </div>
              <div className="flex justify-between items-center">
                <h2 className="text-2xl text-purple-100 font-bold">Final Total:</h2>
                <p className="text-2xl text-purple-100 font-bold">
